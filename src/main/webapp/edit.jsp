...
<div class="container">
    <form class="row g-3 needs-validation" novalidate>
        <div class="col-md-2">
            ...
            <input type="text" class="form-control" id="validationCustom01" value="Phil" required>
        ...
        <div class="col-md-10">
            ...
            <input type="text" class="form-control" id="validationCustom02" value="placeholdertext placeholdertext placeholdertext placeholdertext" required>
            <div class="valid-feedback">
                Looking good!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="col-md-4">
            ...
            <input type="tel" class="form-control" id="validationCustom03" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" value="010-3456-7890" required>
            <div class="valid-feedback">
                Looking good!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="col-8">
            <a href="edit.jsp"><button class="btn btn-primary d-inline-flex align-items-center" type="submit">
                <i class="bi bi-pencil-fill"></i>&nbsp; Edit
            </button></a>
            <a href="view.jsp"><button class="btn btn-danger d-inline-flex align-items-center" type="button">
...
<script src="./form_edit.js" type="module"></script>
</body>
</html>
